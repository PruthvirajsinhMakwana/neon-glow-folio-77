...
const HeroSection = () => {
  ...
  return (
    <section className="min-h-screen flex flex-col relative z-10 overflow-hidden">
      {/* 3D Model - Upper Section */}
      ...
      {/* Text Content - Lower Section */}
      <div className="flex-1 flex flex-col items-center justify-center px-4 py-8 relative z-[10] bg-gradient-to-t from-background via-background to-transparent">
        <div className="text-center max-w-4xl mx-auto">
          {/* Main heading */}
          <div className="overflow-hidden mb-4">
            <h1 
              className={`text-4xl md:text-6xl lg:text-7xl font-bold transform transition-all duration-1000 ${
          ...
          <div className="overflow-hidden mb-6">
            <p 
              className={`text-lg md:text-xl text-muted-foreground transform transition-all duration-1000 delay-300 ${
                textVisible ? 'translate-y-0 opacity-100' : 'translate-y-20 opacity-0'
              }`}
            >
          ...
          {/* Action buttons */}
          <div 
            className={`flex flex-col sm:flex-row gap-3 justify-center mb-6 transform transition-all duration-1000 delay-500 ${
              textVisible ? 'translate-y-0 opacity-100' : 'translate-y-20 opacity-0'
            }`}
          >
            <button 
          ...
          {/* Social links */}
          <div 
            className={`flex justify-center space-x-6 mb-6 transform transition-all duration-1000 delay-700 ${
              textVisible ? 'translate-y-0 opacity-100' : 'translate-y-20 opacity-0'
            }`}
          >
            {[
